defmodule Watercooler.Chat.Message do
  ...
  oban do
    triggers do
      trigger :respond do
        actor_persister Watercooler.AiAgentActorPersister
        action :respond
        queue :chat_responses
        lock_for_update? false
        scheduler_cron false
        worker_module_name Watercooler.Chat.Message.Workers.Respond
        scheduler_module_name Watercooler.Chat.Message.Schedulers.Respond
  ...
  actions do
    ...
    create :create do
      ...
      change Watercooler.Chat.Message.Changes.CreateConversationIfNotProvided
    ...
    update :respond do
      ...
      transaction? false
      change Watercooler.Chat.Message.Changes.Respond
    end
  ...
  pub_sub do
    module WatercoolerWeb.Endpoint
    prefix "chat"
  ...
  attributes do
    ...
    attribute :source, Watercooler.Chat.Message.Types.Source do
      allow_nil? false
      public? true
      default :user
    end
  ...
  relationships do
    belongs_to :conversation, Watercooler.Chat.Conversation do
      public? true
      allow_nil? false
    end
