defmodule Watercooler.Chat.Conversation do
  ...
  oban do
    triggers do
      trigger :name_conversation do
        ...
        worker_module_name Watercooler.Chat.Message.Workers.NameConversation
        scheduler_module_name Watercooler.Chat.Message.Schedulers.NameConversation
  ...
  actions do
    ...
    update :generate_name do
      ...
      change Watercooler.Chat.Conversation.Changes.GenerateName
    end
  ...
  relationships do
    has_many :messages, Watercooler.Chat.Message do
      public? true
    end

    belongs_to :user, Watercooler.Accounts.User do
      public? true
      allow_nil? false
    end
  end
